...
<body>
<div class="ok70"><img src="mushroom.jpg" width="150" height="120" alt=""/><h4>
    <center>
    MUSHROOM
...
echo "Mushroom added in cart are: " .$selected_val5;
$sql5 = "INSERT INTO products VALUES ('mushroom','$selected_val5')";
...
<div class="pk0"><img src="tomato.jpg" width="143" height="113" alt=""/>
  <h4>
    <center>
      TOMATO
        <form action="produce.php" method="post">
...
echo "Tomato added in cart are: " .$selected_val4;
$sql4 = "INSERT INTO products VALUES ('tomato','$selected_val4')";
...
<div class="ok67"><img src="potato.jpg" width="137" height="115" alt=""/>
  <h4>
    <center>
      POTATO
        <form action="produce.php" method="post">
...
echo "Potato added in cart are: " .$selected_val3;
$sql3 = "INSERT INTO products VALUES ('potato','$selected_val3')";
...
<div class="ok7">
  <h4><img src="pdc.png" width="290" height="155" alt=""/></h4>
</div>
<div class="ok44">
  <h2>PRODUCE PRODUCTS</h2>
</div>
<div class="rt"><img src="onion.jpg" width="125" height="109" alt=""/>
  <h4>
    <center>
    ONION
      <form action="produce.php" method="post">
...
echo "Onions added in cart are: " .$selected_val;
$sql = "INSERT INTO products VALUES ('onion','$selected_val')";
...
<div class="ok55"><img src="pepper.png" width="126" height="115" alt=""/>
  <h4>
    <center>
      GREEN PEPPER
      <form action="produce.php" method="post">
...
echo "Green peper added in cart are: " .$selected_val1;
$sql2 = "INSERT INTO products VALUES ('greenpepper','$selected_val1')";
...
<div class="ok80"><img src="cabbage.jpg" width="130" height="120" alt=""/>
<h4><center>
  CABBAGE
      <form action="produce.php" method="post">
...
echo "Cabbage added in cart are: " .$selected_val6;
$sql6 = "INSERT INTO products VALUES ('cabbage','$selected_val6')";
