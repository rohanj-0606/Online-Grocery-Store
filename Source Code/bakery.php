...
<body>
<div class="ok70"><img src="cookie.jpg" width="150" height="120" alt=""/><h4>
    <center>
    COOKIES
...
echo "Cookies added in cart are: " .$selected_val5;
$sql5 = "INSERT INTO products VALUES ('cookies','$selected_val5')";
...
<div class="pk0"><img src="cake.jpg" width="143" height="113" alt=""/>
  <h4>
    <center>
      CAKE
        <form action="bakery.php" method="post">
...
echo "Cakes added in cart are: " .$selected_val4;
$sql4 = "INSERT INTO products VALUES ('cake','$selected_val4')";
...
<div class="ok67"><img src="cupcake.jpg" width="137" height="115" alt=""/>
  <h4>
    <center>
      CUP CAKES
        <form action="bakery.php" method="post">
...
echo "Cupcakes added in cart are: " .$selected_val3;
$sql3 = "INSERT INTO products VALUES ('cupcakes','$selected_val3')";
...
<div class="ok7">
  <h4><img src="bake.jpg" width="290" height="155" alt=""/></h4>
</div>
<div class="ok44">
  <h2>BAKERY PRODUCTS</h2>
</div>
<div class="rt"><img src="bread.jpg" width="125" height="109" alt=""/>
  <h4>
    <center>
    BREAD
    <form action="bakery.php" method="post">
...
echo "Breads added in cart are: " .$selected_val;
$sql = "INSERT INTO products VALUES ('bread','$selected_val')";
...
<div class="ok55"><img src="cros.jpg" width="125" height="109" alt=""/>
  <h4>
    <center>
      CROISSANT
      <form action="bakery.php" method="post">
...
echo "Croissant added in cart are: " .$selected_val1;
$sql2 = "INSERT INTO products VALUES ('croissant','$selected_val1')";
...
<div class="ok80"><img src="bsticks.jpg" width="130" height="120" alt=""/>
<h4><center>
  BREADSTICKS
  <form action="bakery.php" method="post">
...
echo "BreadSticks added in cart are: " .$selected_val6;
$sql6 = "INSERT INTO products VALUES ('breadstick','$selected_val6')";
