...
<body>
<div class="ok70"><img src="burger.png" width="150" height="120" alt=""/><h4>
    <center>
      BURGER PATTY
...
echo "Burger Patty added in cart are: " .$selected_val5;
$sql5 = "INSERT INTO products VALUES ('patty','$selected_val5')";
...
<div class="pk0"><img src="fries.jpg" width="143" height="113" alt=""/>
  <h4>
    <center>
      FRENCH FRIES
        <form action="frozen.php" method="post">
...
echo "Fries added in cart are: " .$selected_val4;
$sql4 = "INSERT INTO products VALUES ('fries','$selected_val4')";
...
<div class="ok67"><img src="vegie.jpg" width="137" height="115" alt=""/>
  <h4>
    <center>
      FROZEN VEGGIES
        <form action="frozen.php" method="post">
...
echo "Frozen veggies added in cart are: " .$selected_val3;
$sql3 = "INSERT INTO products VALUES ('veggies','$selected_val3')";
...
<div class="ok7">
  <h4><img src="frozen_foods.jpg" width="290" height="155" alt=""/></h4>
</div>
<div class="ok44">
  <h2>FROZEN PRODUCTS</h2>
</div>
<div class="rt"><img src="pizza.jpg" width="125" height="109" alt=""/>
  <h4>
    <center>
      FROZEN PIZZA
        <form action="frozen.php" method="post">
...
echo "Frozen pizza added in cart are: " .$selected_val;
$sql = "INSERT INTO products VALUES ('pizza','$selected_val')";
...
<div class="ok55"><img src="icecream.png" width="125" height="109" alt=""/>
  <h4>
    <center>
      ICE CREAM
        <form action="frozen.php" method="post">
...
echo "Ice cream added in cart are: " .$selected_val1;
$sql2 = "INSERT INTO products VALUES ('icecream','$selected_val1')";
...
<div class="ok80"><img src="sea.jpg" width="130" height="120" alt=""/>
<h4><center>
  SEA FOOD
      <form action="frozen.php" method="post">
...
echo "Sea food added in cart are: " .$selected_val6;
$sql6 = "INSERT INTO products VALUES ('seafood','$selected_val6')";
