...
<div class="ok23"><center>
    <h1>PAYMENT DETAILS  OF CUSTOMER  </h1>
    ...
    if(mysqli_num_rows($result) > 0){
        ...
        while($row = mysqli_fetch_array($result)){
            echo "<tr>";
                ...
                echo "<td>" . $row['exprydate'] . "</td>";
                echo "<td>" . $row['cvv'] . "</td>";
				echo "<td>" . $row['zipcode'] . "</td>";
				echo "<td>" . $row['type'] . "</td>";
				echo "<td><a href=\"updatepay.php?id=".$row['id']."&status=app\">Update</a></td>";
				echo "<td><a href=\"delpay.php?id=".$row['id']."&status=app\">Delete</a></td>";
            echo "</tr>\n";
        }
        echo "</table>";
        // Close result set
