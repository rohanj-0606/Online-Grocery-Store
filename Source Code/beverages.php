...
<body>
<div class="ok70"><img src="energy.jpg" width="143" height="113" alt=""/><h4>
    <center>
      SPORTS DRINK
        <form action="beverages.php" method="post">
...
echo "Energy Drink added in cart are: " .$selected_val5;
$sql5 = "INSERT INTO products VALUES ('energy drink','$selected_val5')";
...
<div class="pk0"><img src="juice.png" width="143" height="113" alt=""/>
  <h4>
    <center>
      JUICE
      <form action="beverages.php" method="post">
...
echo "Juice added in cart are: " .$selected_val4;
$sql4 = "INSERT INTO products VALUES ('juice','$selected_val4')";
...
<div class="ok67"><img src="water.jpg" width="115" height="108" alt=""/>
  <h4>
    <center>
      WATER
        <form action="beverages.php" method="post">
...
echo "Water added in cart are: " .$selected_val3;
$sql3 = "INSERT INTO products VALUES ('water','$selected_val3')";
...
<div class="ok7">
  <h4><img src="bgv.jpg" width="290" height="155" alt=""/></h4>
</div>
<div class="ok44">
  <h2>BEVERAGES</h2>
</div>
<div class="rt"><img src="coffee.jpg" width="125" height="109" alt=""/>
  <h4>
    <center>
      COFFEE
        <form action="beverages.php" method="post">
...
echo "Coffee added in cart are: " .$selected_val;
$sql = "INSERT INTO products VALUES ('coffee','$selected_val')";
...
<div class="ok55"><img src="tea.jpg" width="125" height="109" alt=""/>
  <h4>
    <center>
      TEA
        <form action="beverages.php" method="post">
...
echo "Tea added in cart are: " .$selected_val1;
$sql2 = "INSERT INTO products VALUES ('tea','$selected_val1')";
...
<div class="ok80"><img src="soft.jpg" width="142" height="116" alt=""/>
<h4><center>
SOFT DRINKS
<form action="beverages.php" method="post">
...
echo "Soft Drink added in cart are: " .$selected_val6;
$sql6 = "INSERT INTO products VALUES ('soft drinks','$selected_val6')";
