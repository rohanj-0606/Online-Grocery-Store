...
<body>
<div class="ok70"><img src="yogurt.jpg" width="143" height="113" alt=""/><h4>
    <center>
      YOGURT<form action="dairy.php" method="post">
...
echo "Yogurt added in cart are: " .$selected_val5;
$sql5 = "update products set quant='$selected_val5' where cust_id='1' and prod_name='yogurt'";;
...
<div class="pk0"><img src="butter.jpg" width="143" height="113" alt=""/>
  <h4>
    <center>
      BUTTER
...
echo "Butter added in cart are: " .$selected_val4;
$sql4 = "update products set quant='$selected_val4' where cust_id='1' and prod_name='butter'";;
...
<div class="ok67"><img src="cheese.jpg" width="115" height="108" alt=""/>
  <h4>
    <center>
      CHEESE
      <form action="dairy.php" method="post">
...
echo "Cheese added in cart are: " .$selected_val3;
$sql3 = "update products set quant='$selected_val3' where cust_id='1' and prod_name='cheese'";;
    ...
    <center>
      ...
      <form action="dairy.php" method="post">
        <select name="quant" id="quant">
          <?php
		  include("config.php");
				  $result4= mysqli_query("select quant from products where prod_name='egg'"); 
while($row = mysqli_fetch_array($result4)){ 
echo '<option value="' .$row['quant']. '">'. $row['quant']. '</option>' ; 
} 
?> 
        </select>
...
<div class="ok55"><img src="milk.jpg" width="125" height="109" alt=""/>
  <h4>
    <center>
      MILK
      <form action="dairy.php" method="post">
...
echo "Milk cans added in cart are: " .$selected_val1;
$sql2 = "insert into products values ('{$_SESSION['cid']}','milk','$selected_val1')";
...
<div class="ok80"><img src="sourcream.jpg" width="142" height="116" alt=""/>
<h4><center>SOUR CREAM
<form action="dairy.php" method="post">
...
echo "sour cream added in cart are: " .$selected_val6;
$sql6 = "update products set quant='$selected_val6' where cust_id='1' and prod_name='sourcream'";;
